...
import static es.fercbrt.springbootcrudjpa.config.security.JwtConfig.*;

import com.fasterxml.jackson.databind.ObjectMapper;
import es.fercbrt.springbootcrudjpa.config.security.SimpleGrantedAuthorityJsonCreator;
